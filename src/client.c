...
/*   Updated: 2024/09/17 11:02:43 by mde-souz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * It converts the PID from a string to an integer, sets up a signal handler, and sends the message
 * to the server process using signals.
 *
